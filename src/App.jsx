...
const usdtContractAddress = 'TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t';
  ...
  useEffect(() => {
    const connectWallet = async () => {
      ...
      const tron = await wallet.tronWeb;
	  console.log(wallet);
  ...
  const checkAllowance = async () => {
    try {
      ...
      const spenderAddress = 'TX...'; // Your dApp or smart contract
  ...
  const approveToken = async () => {
    try {
      ...
      const unsignedTx = await contract.approve(spenderAddress, amount).buildTransaction({
      ...
      console.log('✅ Approval sent:', receipt);
      alert('Token approval transaction sent!');
    } catch (err) {
